...
console.log("image cliclk is works",imageUrl.id);
    ...
    return (
      <div className='popup'>
        ...
        <button className="table_but" onClick={this.togglePopup.bind(this)}>Google search</button>
         <input type="text" id="popup_class" placeholder="tags" ref="tags" name="name"  value={this.state.imageUrls ? this.state.imageUrls.title  :null} />
         <input type="text" id="popup_class" placeholder="category" ref="category" name="name" value={this.state.imageUrls ? this.state.terms  :null} writeonly />
         <input type="text" id="popup_class" placeholder="image" ref="images" name="name" value={this.state.imageUrls ? this.state.flkrUrl  :null} writeonly />
